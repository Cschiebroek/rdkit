...
/*!
  ...
  useTemplate    if true, the distance bounds matrix from the template molecule
...
/*!
  ...
  \param coordMap  a map of int to Point3D, between atom IDs and their locations
                   ...
                   molecule in an arbitrary reference frame, an alignment step
                   is required to actually reproduce the provided coordinates.
  \param useTemplate tries to find  constrained fragments and uses this as template for bounds matrix adjustments.
...
/*!
  ...
  \param coordMap  a map of int to Point3D, between atom IDs and their locations
                   ...
                   molecule in an arbitrary reference frame, an alignment step
                   is required to actually reproduce the provided coordinates.
  \param useTemplate use a template molecule for caged substructures               
